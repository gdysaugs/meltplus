...
export function Image() {
  ...
  const submitImage = useCallback(
    ...
    [height, magicPromptEnabled, negativePrompt, prompt, width],
  )
      ...
      <main className="studio-wrap">
        <section className="studio-panel studio-panel--controls">
          <header className="studio-heading">
            <h1>I2I Edit Studio</h1>
            <p>参照画像をベースに生成・編集します。</p>
          </header>

          <p className="studio-token-line">
            クレジット残高:
            <strong className="studio-token-value">{session ? ticketCount ?? 0 : '--'}</strong>
            <span className="studio-token-cost">{`消費: ${IMAGE_TICKET_COST}クレジット`}</span>
          </p>
          ...
          <section className="studio-section">
            ...
            <label className="studio-field">
              ...
              <textarea
                ...
                placeholder="例: 光をやわらかくし、肌の質感を自然に整える"
              />
            </label>
            ...
            <label className="studio-field">
              ...
              <textarea
                ...
                placeholder="例: 文字化け、ぼやけ、過度な加工感、ノイズ"
              />
            </label>
          </section>
      ...
      {showTicketModal && (
        <div className="studio-modal-overlay" role="dialog" aria-modal="true">
          <div className="studio-modal-card">
            <h3>クレジット不足</h3>
            <p>画像生成にはクレジット1枚が必要です。購入ページで追加してください。</p>
